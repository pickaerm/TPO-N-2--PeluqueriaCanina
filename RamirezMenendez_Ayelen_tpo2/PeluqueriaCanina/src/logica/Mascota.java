...
//CONTRUCTORES
    ...
    public Mascota(int id_mascota, int num_cliente, String nombre_perro, String raza, String color, boolean alergico, boolean atencion_especial, String nombre_duenio, String celular_duenio, String observaciones) {
...
//METODO TOSTRING para imprimir el objeto por pantalla
    @Override
    public String toString() {
        return "Mascota{" + "id_mascota=" + id_mascota + ", num_cliente=" + num_cliente + ", nombre_perro=" + nombre_perro + ", raza=" + raza + ", color=" + color + ", alergico=" + alergico + ", atencion_especial=" + atencion_especial + ", nombre_duenio=" + nombre_duenio + ", celular_duenio=" + celular_duenio + ", observaciones=" + observaciones + '}';
    }
